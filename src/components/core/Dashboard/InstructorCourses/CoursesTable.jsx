                ...
                <Td className="flex flex-1 gap-x-4">
                  ...
                  <div className="flex flex-col justify-between">
                    ...
                    {course.status === COURSE_STATUS.DRAFT ? (
                      <div className="flex w-fit flex-row items-center gap-2 rounded-full bg-richblack-700 px-2 py-[2px] max-sm:text-[10px] sm:text-xs md:text-sm lg:text-base font-medium text-pink-100">
                        <HiClock size={14} />
                        Drafted
                      </div>
                    ) : (
                      <div className="flex w-fit flex-row items-center gap-2 rounded-full bg-richblack-700 px-2 py-[2px] max-sm:text-[10px] sm:text-xs md:text-sm lg:text-base font-medium text-yellow-100">
