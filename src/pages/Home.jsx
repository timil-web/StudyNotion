    ...
    <div className='bg-pure-greys-5 text-richblack-700'>
      <div className='homepage_bg h-[333px]'>
        ...
        <div className='w-11/12 max-w-maxContent flex flex-col items-center justify-between gap-5 mx-auto'>
          ...
          <div className='flex lg:flex-row gap-7 text-white'>
            <CTAButton active={true} linkto={"/signup"}>
      ...
      <div className='mx-auto w-11/12 max-w-maxContent flex flex-col items-center justify-between gap-7'>
        ...
        <div className='flex flex-col md:flex-row gap-5 mb-10 mt-[95px]'>
          ...
          <div className='flex flex-col gap-10 md:w-[40%] md:items-start items-center'>
	  ...
	  {/* section 3 */}
    <div className='w-11/12 max-w-maxContent mx-auto flex flex-col items-center gap-8 justify-between first-letter bg-richblack-900 text-white'>
